...
> Репозиторий-структура, полученная из Вашего архива, предполагает деплой каталога `public/`
в качестве web root. Серверные зависимости — только PHP с расширениями `dom`, `libxml`, `mbstring`.
